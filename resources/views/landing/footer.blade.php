        ...
        <div class="lg:flex lg:items-start lg:gap-8">
            ...
            <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                <div class="col-span-2 text-justify">
                    <div>
                        <h2 class="text-1.9xl font-bold text-gray-900 dark:text-white uppercase">Compassionate Care, Advanced Healing</h2>
                        <p class="mt-4 text-gray-500 dark:text-gray-400">
                            Sandesh Hospital strategically located at Basundhara, Kathmandu, is a private hospital providing ethical and personalized care within an infrastructure on par with the best facility in the country. Sandesh Hospital commenced its operation in December 2025, offering both out-patient services and in-patient services.
                        </p>
                    </div>
                </div>
        ...
        <div class="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
            <div class="sm:flex sm:justify-between">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    &copy; 2025. Sandesh Giri. All rights reserved.
                </p>
